...
<body>
    <form id="form1" runat="server">
        <div style="height: 335px">
            <asp:Label ID="Label1" runat="server" Text="Welcome to the Student login form" ></asp:Label>
...
&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" BackColor="#006699" Text="Login" OnClick="Button1_Click1" />
            <br />
            <br />
            <br />
