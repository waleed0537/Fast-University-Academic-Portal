<%@ Page Language="C#" AutoEventWireup="true" CodeFile="facultysignup.aspx.cs" Inherits="facultysignup" %>
    ...
    <form id="form1" runat="server">
        <div style="height: 335px">
          <asp:Label ID="Label1" runat="server" Text="Welcome to the Student Sighnup form" ></asp:Label>
            ...
            <br />
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="TextBox1" runat="server" placeholder="Stu-ID"></asp:TextBox>
            <br />
            <br />
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" BackColor="#006699" ForeColor="White" Text="Signup" OnClick="Button1_Click" />
            <br />
            <br />
            <br />
        </div>
